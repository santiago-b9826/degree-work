...
public class DSLParallelMetaheuristicParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'Config'", "'Execution'", "'Team'", "'Worker'", "'Pool'", 
		"'{'", "'}'", "'>'", "'<'", "'#'", "':'", "','", "NUMBER", "STRING", "WS"
	};
	public static final int
	...
	public final StartContext start() throws Exception {
		...
		try {
			...
			setState(11); match(CONFIG);
			setState(12); match(OPEN_CURLY_BRACKET);
			setState(18);
			...
			while (_la==STRING) {
				{
				{
				setState(13); ((StartContext)_localctx).s1 = assign();
			...
			setState(21); match(CLOSE_CURLY_BRACKET);
			setState(22); match(EXECUTION);
			setState(23); match(OPEN_CURLY_BRACKET);
			setState(27); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				{
				{
				setState(24); ((StartContext)_localctx).s2 = team();
			...
			setState(31); match(CLOSE_CURLY_BRACKET);
	...
	public final TeamContext team() throws RecognitionException {
		...
		try {
			...
			setState(35); match(TEAM);
			setState(40);
			_la = _input.LA(1);
			if (_la==LESS_THAN) {
				{
				setState(36); match(LESS_THAN);
				setState(37); ((TeamContext)_localctx).NUMBER = match(NUMBER);
				 quantity = new Constant(Integer.parseInt((((TeamContext)_localctx).NUMBER!=null?((TeamContext)_localctx).NUMBER.getText():null))); 
				setState(39); match(GREATER_THAN);
				}
			}

			setState(42); match(OPEN_CURLY_BRACKET);
			setState(46); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				{
				{
				setState(43); ((TeamContext)_localctx).s1 = worker();
			...
			while (_la==POOL) {
				{
				{
				setState(50); ((TeamContext)_localctx).s2 = pool();
			...
			setState(58); match(CLOSE_CURLY_BRACKET);
	...
	public final WorkerContext worker() throws RecognitionException {
		...
		try {
			...
			setState(62); match(WORKER);
			setState(67);
			_la = _input.LA(1);
			if (_la==LESS_THAN) {
				{
				setState(63); match(LESS_THAN);
				setState(64); ((WorkerContext)_localctx).NUMBER = match(NUMBER);
				 quantity = new Constant(Integer.parseInt((((WorkerContext)_localctx).NUMBER!=null?((WorkerContext)_localctx).NUMBER.getText():null))); 
				setState(66); match(GREATER_THAN);
				}
			}
			...
			while (_la==STRING) {
				{
				{
				setState(70); ((WorkerContext)_localctx).s1 = assign();
	...
	public final PoolContext pool() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(81); match(POOL);
			setState(82); match(OPEN_CURLY_BRACKET);
			 List<ASTNode> body = new ArrayList<ASTNode>(); 
			setState(89);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==STRING) {
				{
				{
				setState(84); ((PoolContext)_localctx).s1 = assign();
			...
			setState(92); match(CLOSE_CURLY_BRACKET);
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			...
			setState(96); ((AssignContext)_localctx).STRING = match(STRING);
